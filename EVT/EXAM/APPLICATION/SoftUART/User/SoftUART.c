...
void EXTI15_10_IRQHandler(void) __attribute__((interrupt("WCH-Interrupt-fast"))); /* Interrupt handler function */
/*********************************************************************
...
static void RxInit(void)
{
    ...
    NVIC_SetPriority(EXTI15_10_IRQn,0<<4);
...
void Init(u32 baudrate)
{
    ...
    SoftUARTHardware.rxPort = GPIOB;
    SoftUARTHardware.rxPin = GPIO_Pin_12;
