...
void FSMC_SRAM_Init(void)
{
    ...
    RCC_PB2PeriphClockCmd(RCC_PB2Periph_GPIOB | RCC_PB2Periph_GPIOD | RCC_PB2Periph_GPIOE,ENABLE);
    ...
    //FSMC_D9(PB11) FSMC_D10(PB12) FSMC_D11(PB13) FSMC_D12(PB14) 
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_13|GPIO_Pin_14;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_High;
    GPIO_Init(GPIOB, &GPIO_InitStructure);
    //FSMC_D2(PD0) FSMC_D3(PD1) FSMC_NOE(PD4) FSMC_NWE(PD5) FSMC_D13(PD8) FSMC_D14(PD9) FSMC_D15(PD10) FSMC_A16(PD11) FSMC_A17(PD12) FSMC_D0(PD14) FSMC_D1(PD15) 
    ...
    //FSMC_NBL0(PE0)  FSMC_NBL1(PE1) FSMC_D4(PE7) FSMC_D5(PE8) FSMC_D6(PE9) FSMC_D7(PE10) FSMC_D8(PE11)
