...
__attribute__((aligned(4))) static const uint8_t SetupSetFeature[ ] = 
{ 
    0x00, 0x03, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00 
};

/* Clear Feature Command Packet */
...
extern uint8_t HID_SetFeature( uint8_t ep0_size, uint8_t intf_num, uint8_t duration, uint8_t reportid );
extern uint8_t HID_ClearFeature( uint8_t ep0_size, uint8_t intf_num, uint8_t duration, uint8_t reportid );
extern uint8_t HID_SetFeature( uint8_t ep0_size, uint8_t intf_num, uint8_t duration, uint8_t reportid );
extern uint8_t HID_ClearFeature( uint8_t ep0_size, uint8_t intf_num, uint8_t duration, uint8_t reportid );
#ifdef __cplusplus
}
