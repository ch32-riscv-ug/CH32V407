...
#define PAGE_WRITE_START_ADDR     ((uint32_t)0x080F8000 - 0x3000) /* Start from (992K - 12k) */
#define PAGE_WRITE_END_ADDR       ((uint32_t)0x080F8000) /* End at 992K */
#define FLASH_PAGE_SIZE           4096

#define BASIC_CFG_ADDR            ((uint32_t)0x080F8000 - 0x3000)
#define PORT_CFG_ADDR             ((uint32_t)0x080F8000 - 0x2000)
#define LOGIN_CFG_ADDR            ((uint32_t)0x080F8000 - 0x1000)
